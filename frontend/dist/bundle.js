...
/* harmony export */   "postOperation": () => (/* binding */ postOperation)
/* harmony export */ });
...
var getOperation = function getOperation() {
  axios__WEBPACK_IMPORTED_MODULE_1___default().get('http://localhost:8000/task', baseHeaders).then(function (response) {
    var _document$querySelect = document.querySelectorAll('.form-control'),
        _document$querySelect2 = _slicedToArray(_document$querySelect, 5),
        opLeft = _document$querySelect2[0],
